...
function delta(lat, lng) {
    ...
    var d = mapTransform(lng - 105.0, lat - 35.0);
...
var map_transform = exports

exports.a_wgs2gcj = ([lng, lat]) => {
    let res = wgs2gcj(lat, lng)
    return [res.lng,res.lat, ]
}
export default map_transform;
